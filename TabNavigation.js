class TabNavigation {
  ...
  static staticConstructor(spriteCanvas) {
    ...
    this.colorModalSections = ["colorModalColorsSection", "colorModalTransitionSection", "colorModalEffectsSection", "colorModalBackgroundSelection", "colorModalFontSection"];
  }
  ...
  static setSelectedSprite(selectedSprite, indexInSpriteArray) {
    ...
    // Keep the weapon editor in sync
    if (selectedSprite.type === SpritePixelArrays.SPRITE_TYPES.weapons && typeof WeaponAttributesRenderer !== 'undefined') {
      WeaponAttributesRenderer.syncSelectedWeaponType(selectedSprite.name);
    }
  }
